...
public class MyViewLoan68 {
    ...
    private static MyViewLoan68 db = null;

    public static MyViewLoan68 getInstance() {
    ...
    public Connection getConnect() throws SQLException, Exception {
        try {
            ...
            if (conn == null) {
                ...
                // 手工指定链接68服务器；因为客户要求判断两台数据库的链接状态
                String url = "jdbc:oracle:thin:@10.229.41.68:1521:admas2";
                //Service.getOracleDriverUrl();
                conn = DriverManager.getConnection(url, "viewloan", "loan1234");
            }
            return conn;
