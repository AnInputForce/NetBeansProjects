...
*/
	...
	private static RepData db = null;

	public static RepData getInstance() {
	...
	public Connection getConnect() throws SQLException, Exception {
	    try {
	      ...
	      {	      
		      ...
		      String url = Service.getOracleDriverUrlREP();
		      conn = DriverManager.getConnection(url, "dataser", "db2011dr");
	      }
	      return conn;
	    }
