...
public class IReportPrintImpl implements IReportPrint {
  public static String reportPath ="/ireport";//=  "/WEB-INF/report"; //报表配置文件目录
  public static boolean complie =true;//= false; //报表编译标记
  private ServletContext application;  //上下文
  private HttpServletResponse response;  //响应
  private String reportName;  //报表名称
  private Map parameter = new HashMap();//所需参数
  private JRDataSource jRDataSource = new JRDateSource();//报表数据源
