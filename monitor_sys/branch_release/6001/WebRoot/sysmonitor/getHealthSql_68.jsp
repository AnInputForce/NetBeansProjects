...
<%@page import="com.git.base.dbmanager.MyViewLoan68"%>
      ...
      <table width="60%">
        <%
            try {
              ...
              MyViewLoan68 dbloan = MyViewLoan68.getInstance();
