...
<html>
  <head>
    ...
    <%
            ...
            if (request.getParameter("leftclick") != null) {
                ...
                response.sendRedirect("RepTranData.jsp");
  ...
  <body><br>
    ...
    <%
      if  ("true".equals(request.getParameter("formtaskalertflag") == "true")){
        try {
          String sqltaskalert = null ; 
          RepData dbrepsqltaskalert = RepData.getInstance();
          int updatenums = 0;
          sqltaskalert = "update task set taskstatus='2' where taskname  in ('taskalert9')";
      ...
      <table  border=1 cellspacing="0" cellpadding="5">
        ...
        <%
                try {
                    ...
                    RepData dbrep = RepData.getInstance();
