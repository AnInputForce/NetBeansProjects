...
document.write("<div id=meizzCalendarLayer style='position: absolute; z-index: 9999; width: 142px; height: 165px; display: none'>");
document.write("<iframe name=meizzCalendarIframe scrolling=no frameborder=0 width=100% height=100%></iframe></div>");
function writeIframe()
{
    var strIframe = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=gb2312'><style>"+
    "*{font-size: 12px; font-family: 宋体}"+
    ".bg{  color: "+ WebCalendar.lightColor +"; cursor: default; background-color: "+ WebCalendar.darkColor +";}"+
    "table#tableMain{ width: 142; height: 160;}"+
    "table#tableWeek td{ color: "+ WebCalendar.lightColor +";color:#000;}"+
    "table#tableDay  td{ font-family: Arial, Helvetica, sans-serif;}"+
    ...
    "    <tr align=center style=background:#D0E9FF;><td height=20>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr></table>"+
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         WebCalendar.btnBgColor +";cursor: hand; padding-top: 1px; width: 100%; height: 100%;color:#FFF;background:#A1CEF6;border-top: solid 1px #B6DDFF; border-left: solid 1px #B6DDFF; border-right: solid 1px #A1CEF6; border-bottom: solid 1px #A1CEF6;' onfocus='this.blur()'"+
...
function TWebCalendar() //初始化日历的设置
{
    ...
    this.format     = "yyyymmdd"; //回传日期的格式
    this.timeShow   = false;        //是否返回时间
    this.drag       = true;         //是否允许拖动
    this.darkColor  = "#A1CEF6";    //控件的暗色
    ...
    this.todayColor = "#C0C0C0";    //今天在日历上的标示背景色
