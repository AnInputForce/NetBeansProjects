...
Connection conn = DriverManager.getConnection(url, "sdp", "sdlo2db2");
		...
		double  dSucc = 0.00;
		String  sSuccLv =null;
		dSucc = Double.parseDouble(sSucCNT)/Double.parseDouble(sCNT)*100;
		java.text.DecimalFormat df = new java.text.DecimalFormat("##.##");		
        df.format(dSucc);	
        sSuccLv = String.valueOf(df.format(dSucc))+"%";
		
		//System.out.println("succ lv:"+ df.format(dSucc)+"%");
		...
		rs = stmt.executeQuery("select trim(asz0date) as busidate," +
								...
								"where asz0rsco<>'0000' and asz0rsco<>'****' and asz0date >= '"+start+"' and substr(asz0date,0,10) <= '"+end+"'");					
