	...
	<body>
		...
		<form name="form1" method="post">
			...
			<table border="1" >
				...
				<%					
				   	sql="select r.hostID,r.srvname ,h.hostDesc from  tux_server_reg r, Hosts h where h.hostID = r.hostID ";				
				   	rs = db.selectSql(sql);
		...
		<%
			...
			%>
				<script> window.open("updatetuxsrv.jsp");	</script>
			<%
				}
		%>
		...
		<%
		    	...
		    	str = "putname[" + index + "][1]";			 
		    	tuxprocname = request.getParameter(str);
				sql = "delete from tux_server_reg where  srvname= '" + tuxprocname.trim() + "' and hostID= '" + hostID.trim()+ "'";
