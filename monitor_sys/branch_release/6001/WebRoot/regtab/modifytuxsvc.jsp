	...
	<body>
		...
		<form name="form1" method="post">
			...
			<table border="1" >
				...
				<%	
					sql="select r.hostID,r.svcname ,h.hostDesc from  tux_service_reg r, Hosts h where h.hostID = r.hostID ";				
				   	rs = db.selectSql(sql);
					rows = rs.getRowCount();
		...
		<%
			...
			%>
				<script> window.open("updatetuxsvc.jsp");	</script>
			<%
				}
		%>
		...
		<%
		    	...
		    	str = "putname[" + index + "][1]";			 
		    	servername = request.getParameter(str);
				sql = "delete from tux_service_reg where  svcname= '" + servername.trim() + "' and hostID= '" + hostID.trim()+ "'";
